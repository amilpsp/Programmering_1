...
public class inlU3_ForstaOchSistaOrd {
    public static void main(String[]args){
        ...
        String forstaOrdet = trimmatMening.substring(
                0,iOfFirstSpace);                                   //Making a substring from the beginning until the first space.
        System.out.println(
                "Det första ordet var \"" + forstaOrdet + "\".");   //Printing on the console

        int indexOfLastSpace = trimmatMening.lastIndexOf(" ");  //The index of the last space is the beginning of the last word.

        String sistaOrdet = trimmatMening.substring(
                indexOfLastSpace + 1                                //Making a substring from the after the last space.
        );
        System.out.println(
                "Det sista ordet var \"" + sistaOrdet + "\".");     //Printing on the console
    }
}